# FastAPI AI Agent A backend service built with **FastAPI** that demonstrates integration of AI reasoning with external API tools like **weather** and **Wikipedia lookups**. ## How the Solution Works 1. The backend exposes a single endpoint: # Request Example:
json
{
